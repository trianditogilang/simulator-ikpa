...
| TSD-QG-02 | Migration database kosong/staging | F7-15, F13-08 | Needs Fix — local migration check lulus; repository secrets tersedia, remote gate belum dijalankan sampai perubahan dipush |

...
export const mockGuides: GuideItem[] = [
	{
		...
		summary: "Menilai frekuensi pengesahan revisi DIPA per satker pada setiap semester anggaran.",
		formula: "Maksimal 1 revisi per semester = Nilai 100. Lebih dari 1 revisi = Nilai 80.",
	...
	},
	{
		...
		summary: "Menilai kesesuaian antara realisasi anggaran bulanan dengan rencana penarikan dana (RPD).",
		formula: "Rata-rata deviasi bulanan. Deviasi ≤ 5% = 100. Kurva linier turun hingga batas toleransi.",
	...
	},
	{
		...
		summary: "Menilai proporsi realisasi anggaran terhadap pagu DIPA per triwulan menurut jenis belanja.",
		formula: "Target triwulanan: Q1 (15%), Q2 (40%–50%), Q3 (60%–70%), Q4 (90%–95%).",
	...
	},
	{
		...
		summary: "Menilai ketepatan pendaftaran data kontrak ke KPPN maksimal 3 hari kerja sejak penandatanganan.",
	...
	},
	{
		...
		summary: "Menilai ketepatan penerbitan SPM-LS non-pegawai maksimal 17 hari kerja sejak BAST/BAPP.",
	...
	},
	{
		...
		summary: "Menilai ketertiban revolving UP minimal 1 kali sebulan, pertanggungjawaban TUP, dan penggunaan KKP.",
		formula: "Komposit: Ketepatan GUP (50%) + Setoran TUP (25%) + Porsi KKP (25%).",
	...
	},
	{
		...
		summary: "Menilai ketepatan waktu pelaporan (5 hari kerja awal bulan) dan ketercapaian target output (PCRO/RVRO).",
	...
	},
	{
		...
		summary: "Pengurang nilai total IKPA satker akibat penerbitan SPM dispensasi pada akhir tahun anggaran.",
		formula: "Rasio permil dispensasi terhadap total SPM Q4 (rentang pengurangan 0,25 hingga 2,00 poin).",

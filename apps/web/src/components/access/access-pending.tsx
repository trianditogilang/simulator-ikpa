import { LockKeyhole, LogOut, MessageCircle, ShieldAlert } from "lucide-react";
			...
			<div className="rounded-2xl border border-border bg-background p-6 shadow-sm sm:p-8">
				<div className="text-center">
					...
					<p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-muted-foreground">
						Anda berhasil masuk, tetapi email ini belum memiliki mapping sebagai
					...
					<div className="flex items-start gap-2.5">
						...
						<div>
							...
							<ol className="mt-2 list-decimal space-y-1.5 pl-4 text-xs leading-relaxed text-muted-foreground">
								<li>Hubungi Admin KPPN yang menangani satuan kerja Anda.</li>
								<li>Sampaikan email kedinasan yang digunakan untuk login.</li>
				...
				<div className="mt-6 grid gap-3 sm:grid-cols-2">
					...
					<SignOutAction className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg border border-border bg-background px-4 py-2 text-sm font-semibold text-foreground transition-colors hover:bg-surface-muted focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary active:scale-[0.98]">
